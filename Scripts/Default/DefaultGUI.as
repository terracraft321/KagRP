...
void LoadDefaultGUI()
{
	if (v_driver > 0)
	{
		...
		AddIconToken("$WOOD$", "GUI/MaterialIcons.png", Vec2f(16, 16), 1);
		AddIconToken("$STONES$", "GUI/MaterialIcons.png", Vec2f(16, 16), 0);
		...
		AddIconToken("$doorkey$", "Key.png", Vec2f(16, 16), 0);
		AddIconToken("$atm$", "ATM.png", Vec2f(16, 16), 0);
		...
		AddIconToken("$goldenblock$", "GoldenBlock.png", Vec2f(8, 8), 0);
		AddIconToken("$pine$", "Trees.png", Vec2f(16, 16), 21);
		AddIconToken("$bushy$", "Trees.png", Vec2f(16, 16), 5);
